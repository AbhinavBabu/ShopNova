  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-primary-700/10 blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-accent-violet/10 blur-[120px]" />
      </div>
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="glass rounded-3xl p-8 border border-dark-500/50 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-accent-violet flex items-center justify-center mx-auto mb-4 shadow-lg shadow-primary-900/30">
